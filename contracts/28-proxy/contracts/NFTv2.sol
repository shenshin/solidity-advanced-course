...
contract MyTokenV2 is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    // upgradable contracts dont have constructors
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }

    // pseudoconstructor - being called only once
    // new versions should not contain initializers
/*     function initialize() initializer public {
        // constructor replacer functions
